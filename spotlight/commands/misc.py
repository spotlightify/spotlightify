...
class GoToCommand(Command):
    ...
    def get_suggestions(self, **kwargs):
        ...
        if parameter == "":
            ...
            return [ExecutableSuggestion(f"{self.title} {kwargs['parameter']}", self.description, "forward", PlaybackManager.goto, parameter=parameter)]
...
class VolumeCommand(Command):
    ...
    def get_suggestions(self, **kwargs):
        ...
        if parameter == "":
            ...
            return [ExecutableSuggestion(f"{self.title} {parameter}", self.description, "volume", PlaybackManager.set_volume, parameter=parameter)]
